                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control @error('llkpmenit') is-invalid @enderror" value="0"
                                    type="text" name="llkpmenit" required>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        {{ __('Menit') }}
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control currency @error('ka') is-invalid @enderror" value="0"
                                    type="text" name="ka" required>
                            </div>
                            @error('ka')
                            <span class="text-danger" role="alert">
                                {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control currency @error('ik') is-invalid @enderror" value="0"
                                    type="text" name="ik" required>
                            </div>
                            @error('ik')
                            <span class="text-danger" role="alert">
                                {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control currency @error('tk') is-invalid @enderror" value="0"
                                    type="text" name="tk" required>
                            </div>
                            @error('tk')
                            <span class="text-danger" role="alert">
                                {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="t3" placeholder="Ke III" class="currency form-control"
                                    required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control currency @error('ak') is-invalid @enderror" value="0"
                                    type="text" name="ak" required>
                            </div>
                            @error('ak')
                            <span class="text-danger" role="alert">
                                {{ $message }}
