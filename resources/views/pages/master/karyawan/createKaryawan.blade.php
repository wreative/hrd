    ...
    <form method="POST" action="{{ route('storeEmployees') }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control nik @error('nik') is-invalid @enderror" name="nik" required
                    autofocus>
                @error('nik')
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control datepicker @error('masuk') is-invalid @enderror" name="masuk"
                    required>
                @error('masuk')
                <span class="text-danger" role="alert">
                    {{ $message }}
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control datepicker @error('kontrak') is-invalid @enderror" name="kontrak"
                    required>
                @error('kontrak')
                <span class="text-danger" role="alert">
                    {{ $message }}
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input class="form-control currency @error('gaji') is-invalid @enderror" type="text" name="gaji"
                    required>
            </div>
            @error('gaji')
            <span class="text-danger" role="alert">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control text-uppercase @error('rek') is-invalid @enderror" name="rek">
            @error('rek')
            <span class="text-danger" role="alert">
                {{ $message }}
            </span>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control text-uppercase @error('no_jmn') is-invalid @enderror" name="no_jmn">
            @error('no_jmn')
            <span class="text-danger" role="alert">
                {{ $message }}
            </span>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control text-uppercase @error('jmn') is-invalid @enderror" name="jmn">
            @error('jmn')
            <span class="text-danger" role="alert">
                {{ $message }}
            </span>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('kota') is-invalid @enderror" name="kota" required>
            @error('kota')
            <span class="text-danger" role="alert">
                {{ $message }}
            </span>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('tmp_lahir') is-invalid @enderror" name="tmp_lahir" required>
            @error('tmp_lahir')
            <span class="text-danger" role="alert">
                {{ $message }}
            </span>
